...
static BOOL (WINAPI *Old_kernel32_SetStdHandle)(
    DWORD nStdHandle,
    HANDLE hHandle
);
...
static BOOL (WINAPI *Old_ntdll_RtlDispatchException)(
...
BOOL WINAPI New_kernel32_SetStdHandle(
    DWORD nStdHandle,
    HANDLE hHandle
) {
    last_error_t lasterror;
    ...
    if(hook_in_monitor() != 0) {
        ...
        set_last_error(&lasterror);
        BOOL ret = Old_kernel32_SetStdHandle(
            nStdHandle,
            hHandle
        );
        return ret;
    ...
    log_api(SIG_kernel32_SetStdHandle,
        ret != FALSE,
        (uintptr_t) ret,
        hash,
        &lasterror,
...
NTSTATUS WINAPI New_ntdll_NtAllocateVirtualMemory(
    ...
    log_api(SIG_ntdll_NtAllocateVirtualMemory,
        ...
        Protect,
        exploit_is_stack_pivoted(),
        exploit_makes_stack_executable(ProcessHandle, orig_base_address, Protect),
        exploit_makes_heap_executable(ProcessHandle, orig_base_address, Protect),
...
NTSTATUS WINAPI New_ntdll_NtProtectVirtualMemory(
    ...
    log_api(SIG_ntdll_NtProtectVirtualMemory,
        ...
        NewAccessProtection,
        exploit_is_stack_pivoted(),
        exploit_makes_stack_executable(ProcessHandle, orig_base_address, NewAccessProtection),
        exploit_makes_heap_executable(ProcessHandle, orig_base_address, NewAccessProtection),
        pid_from_process_handle(ProcessHandle)
    );
...
BOOL WINAPI New_ntdll_RtlDispatchException(
    EXCEPTION_RECORD *ExceptionRecord,
    CONTEXT *Context
) {
    last_error_t lasterror;
    ...
    set_last_error(&lasterror);
    BOOL ret = Old_ntdll_RtlDispatchException(
        ExceptionRecord,
        Context
    );
    get_last_error(&lasterror);
...
static hook_t g_hooks[] = {
    ...
    },
    {
        "kernel32",
        "SetStdHandle",
        (FARPROC) New_kernel32_SetStdHandle,
        (FARPROC *) &Old_kernel32_SetStdHandle,
        .special = 0,
        .report = 0,
        .mode = HOOK_MODE_ALL,
        .type = HOOK_TYPE_NORMAL,
    ...
    },
    {
        ...
        .type = HOOK_TYPE_INSN,
                ...
                .addrcb = &hook_insmodulecb_vbscript,
    ...
    },
    {
        ...
        .type = HOOK_TYPE_INSN,
                ...
                .addrcb = &hook_insmodulecb_jscript,
    ...
    },
    {
        ...
        .type = HOOK_TYPE_INSN,
                ...
                .addrcb = &hook_insmodulecb_escript_api,
    ...
    },
    {
        ...
        .special = 0,
        .report = 0,
        .mode = HOOK_MODE_FLASH,
        .type = HOOK_TYPE_INSN,
        
        
        
                .addrcb = &hook_insmodulecb_flash32_20_0_0_228,
    ...
    },
    {
        ...
        .type = HOOK_TYPE_INSN,
                ...
                .addrcb = &hook_insmodulecb_jscript9,
...
static const flag_t g_api_flags[MONITOR_HOOKCNT][8] = {
    ...
    [SIG_kernel32_SetStdHandle] = {
        FLAG_SetStdHandle_nStdHandle,
        FLAG_NONE,
    },
    ...
    [SIG_flash32_20_0_0_228_BaseExecMgr_setJit] = {
        FLAG_NONE,
    },
    [SIG_flash32_20_0_0_228_BaseExecMgr_setNative] = {
        FLAG_NONE,
    },
    [SIG_flash32_20_0_0_228_Loader__loadBytes] = {
        FLAG_NONE,
    },
    [SIG_jscript9_JsGlobalObjectDefaultEvalHelper] = {
        FLAG_NONE,
    },
    [SIG_jscript_Math_random] = {
        FLAG_NONE,
    },
};
